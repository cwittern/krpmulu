...
:EXTENT: *Pañcaviṃśatisāhasrikā[mahā] p°p°
:END:
...
:EXTENT: IX, Sarvāstivādavinayavibhāṣā? An
:END:
...
:lang@zh-py: (Hua yan yan yi chao)
:EXTENT: shi) 華嚴演義鈔纂釋 XXXVIII
:END:
...
:lang@zh-py: (San mi chao)
:EXTENT: jian) 三密抄料簡 II
:END:
...
:lang@zh-py: (Da jing yao yi chao)
:EXTENT: jie) 大經要義抄注解 I
:END:
